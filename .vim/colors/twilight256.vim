" twilight256 color scheme file " Maintainer: Neal Milstein - neal dot milstein at gmail dot com
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    hi ColorColumn guibg=lightgrey ctermbg=234
		hi StatusLine   ctermfg=15  guifg=#CCCC00 ctermbg=239 guibg=#4e4e4e cterm=bold gui=bold
		hi StatusLineNC ctermfg=249 guifg=#000000 ctermbg=black guibg=black cterm=none gui=none
    " highlight groups
    ...
    call <SID>X("NonText", "CC00CC", "000000", "bold")
    "call <SID>X("Question", "00ff7f", "", "")
    "call <SID>X("Search", "f5deb3", "cd853f", "")
    call <SID>X("SpecialKey", "CC00CC", "", "")
    ...
    call <SID>X("Comment", "7C7B7B", "", "")
    call <SID>X("Constant", "E48B65", "", "")
    ...
    call <SID>X("Type", "F9EE98", "", "")
		call <SID>X("Variable", "6688A9", "", "")
    call <SID>X("Special", "8DAED4", "", "")
    "Underlined
